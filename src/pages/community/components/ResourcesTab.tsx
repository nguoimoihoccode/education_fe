    ...
    <div className="space-y-6">
      <div className="flex gap-4">
        <div className="flex-1 relative">
          ...
          <input type="text" placeholder="Search resources..." className="w-full pl-11 pr-4 py-3.5 rounded-2xl bg-slate-800/60 border border-white/5 text-white text-sm placeholder-slate-500 focus:border-accent-500 focus:ring-1 focus:ring-accent-500 outline-none transition-all" />
        </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                      ...
                      <span className="flex items-center gap-1 text-[10px] text-slate-500 font-bold">{res.downloads.toLocaleString()} downloads</span>
                    </div>
                  </div>
                  <button className="px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-xs font-bold hover:bg-accent-600 hover:border-accent-600 transition-all">Get</button>
                </div>
              </div>
            );
          })}
